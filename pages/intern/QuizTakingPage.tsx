    ...
    return (
        <div className="bg-base-100 text-base-content min-h-full flex flex-col items-center justify-center p-6">
            <div className="w-full max-w-2xl">
                ...
                <h1 className="text-2xl font-bold text-accent">{quiz.title}</h1>
                ...
                <div className="mt-4">
                    ...
                    <div className="w-full bg-base-200 rounded-full h-2.5">
                        <motion.div className="bg-accent h-2.5 rounded-full" style={{ width: `${progress}%` }} />
                    </div>
                </div>
                ...
                <div className="mt-8 text-right">
                    <button onClick={handleNextQuestion} disabled={selectedAnswer === null} className="inline-flex items-center gap-2 px-8 py-3 bg-primary text-primary-content font-bold rounded-lg hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed">
